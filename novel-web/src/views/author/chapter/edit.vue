<template>
  <div class="chapter-edit-page flex -m-6 h-[calc(100vh-4rem)]">
    <!-- 左侧：可滚动内容区 -->
    ...
    >
      ...
      <template #footer>
        ...
        <template v-else>
          <el-button @click="continuationDialogVisible = false">关闭</el-button>
          <el-button
            v-if="continuationResult?.continuationText"
            type="primary"
          ...
          <el-button
            v-if="continuationResult?.continuationText"
            @click="copyText(continuationResult.continuationText)"
          >
            复制续写
          </el-button>
        </template>
    ...
    >
      ...
      <template #footer>
        ...
        <template v-else>
          <el-button @click="polishDialogVisible = false">关闭</el-button>
          <el-button
            v-if="polishResult?.polishedText"
            type="primary"
            @click="applyPolish"
          >
            替换选中文本
          ...
          <el-button
            v-if="polishResult?.polishedText"
            @click="copyText(polishResult.polishedText)"
          >
            复制润色
          </el-button>
        </template>
...
import { ArrowLeft, ArrowRight, Check, Document, Delete, EditPen, MagicStick, Notebook, Loading, Promotion, Edit, Cpu } from '@element-plus/icons-vue'
